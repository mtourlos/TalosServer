...
public class QuickTest {
	...
	public void testStoreUser() {
		...
		session.beginTransaction();
		User u = new User();
		u.setEmail("zrapanaki@gmail.com");
		u.setConnectedDate(new Date());
		u.setFirstName("Zampeta");
		u.setLastName("Rapanaki");
		u.setPoints(1L);
		Data d = new Data();
		d.setEmail("zrapanaki@gmail.com");
		d.setCinr(88);
 		d.setLatitude(37.370200000f);
		d.setLongitude(23.33610000f);
		d.setOperator("WIND");
		d.setTimestamp(new Date());
		d.setNetworkType("LTE");
